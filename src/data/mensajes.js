const mensajes = {
    CAMBIO_CLAVE_OK: "Clave cambiada correctamente.",
    ROTULO_ELIMINAR_REGISTRO: "Eliminar registro",
    DESEA_ELIMINAR_REGISTRO: '¿Desea eliminar el registro seleccionado? Esta acción es irreversible.',
