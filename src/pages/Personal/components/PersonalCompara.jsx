...
export const PersonalCompara = ({ personal }) => {
    ...
    return <Box mt={2}>
            <Grid container spacing={2}>
                ...
                <Grid item sm={2} xs={6}>
                    <TextField margin="dense" size="small" fullWidth  InputProps={{readOnly: true}}  value={contrato?.salario?.toFixed(2) ?? ""} label="Sueldo" InputLabelProps={{shrink: true}} ></TextField>
                </Grid>
                <Grid item sm={2} xs={6}>
                ...
                <Grid item sm={2} xs={6}>
                    <TextField margin="dense" size="small" fullWidth InputProps={{readOnly: true}} value={contrato?.horas_dia ?? ""}  label="Horas/Día" InputLabelProps={{shrink: true}} ></TextField>
                </Grid>
            </Grid>
        </Box>
}