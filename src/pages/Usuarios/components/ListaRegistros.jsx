...
import { useFormCambiarClave } from "../../_common/useFormCambiarClave";
import { useUsuario } from "../hooks/useUsuario";

const tableTitle = "Gestionar Usuarios";

export const ListaRegistros = () => {
    const { registros, cargandoRegistros, cargandoEliminar, cargandoSeleccionado, 
            onListar, onEliminarRegistro, onNuevoRegistro, onLeerRegistro} = useUsuario();
            ...
            <Grid item xs = {12} md={8}>
                <TableManager
                    ...
                    onActions = {[
                        ...
                        {
                            inRows: true, inToolbar: false, onOnlySelection: false,
                            onLoading: cargandoCambiarClave,
